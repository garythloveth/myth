...
public class VisitorInfoData {
	...
	// public VisitorInfoData() {
	// super();
	// }

	// public VisitorInfoData(String visitorName, String visitorSex, String
	// visitorIDNo,
	// String companyName, String visitorTelNo, String visitToDoName, String
	// vehicleNo, Integer visitorNum,
	...
	public void setVisitorTelNo(String visitorTelNo) {
		this.visitorTelNo = visitorTelNo;
	}

	public String getVisitToDoName() {
		return visitToDoName;
	}

	public void setVisitToDoName(String visitToDoName) {
		this.visitToDoName = visitToDoName;
	}
